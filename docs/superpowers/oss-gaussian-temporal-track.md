...
They are independent and parallel. Ray-Retracing doesn't need temporal warping; Temporal doesn't need denoising. Either may succeed or fail without affecting the other.
