...
RUN_CONFIG = {
    ...
    "srcnn-v6.2-pico-002": {
        ...
        "default_open": True,
        "arch_version": "v6",
        "history_title": "v6.2 Pico (baseline)",
        "status": "stopped early at step 74K -- baseline for v7",
        "summary": "v6.2 Pico-002 -- baseline for v7 comparison. Run terminated 2026-05-12 at step 74,000 of 100,000 (GPU reclaim). Architectural successor v7-pico-005 is the active run; v6.2's step-00074000.pt is the alpha=1 SR PSNR baseline-to-beat per the Phase 3 pass criterion.",
        "note": "Launched 2026-05-08 with v4 spawn architecture: DisocclusionSpawner + DGP dictionary (kills the integer-pixel-aligned spawn basin), ConcatFusion (replaces global cross-attention), latent rank R=16 (passes the H002 SVD energy gate at 0.9918). Stopped on 2026-05-12 at step 74K when the GPU was reclaimed by another process; rather than resume for the remaining 26K steps we moved to v7 because the architecture has changed substantially (N-D Gaussian primitive with V_xt cross-correlation, parent-child loss-adaptive density, OSS-FX time-slice rendering) and the marginal v6.2 training would not validate any of that. v6.2's step-00074000.pt is preserved as the canonical baseline.",
        "headline": [
            {"label": "Status", "value": "stopped at 74K", "caption": "GPU reclaim 2026-05-12"},
            {"label": "Last step", "value_from": "latest_step", "caption": "target was 100K"},
            {"label": "Final loss", "value_from": "loss_total", "caption": "baseline for v7 to beat"},
        ],
    },
    "srcnn-v6.1-pico-001": {
        "active": False,
